 ...
 * @param position {number} this should be the index in the request string we are currently accessing TODO: get
 * clarity on what we are going to call this.
...
// This following line was giving errors: TODO: why?
// export const getInputArgumentFields: {inputFields: {[key: string]:string}[], txArgArray: string[]} =
// (modules, position, request, method) => { //eslint-disable-line
export const getInputArgumentFields = (modules, position, request, method) => { //eslint-disable-line
